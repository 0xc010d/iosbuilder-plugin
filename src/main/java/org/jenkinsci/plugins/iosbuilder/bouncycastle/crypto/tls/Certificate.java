...
{
    public static final Certificate EMPTY_CHAIN = new Certificate(new org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate[0]);

    /**
     * The certificates.
     */
    protected org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate[] certs;
    ...
    {
        org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate[] certs;
        ...
        while (left > 0)
        {
            ...
            tmp.addElement(org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate.getInstance(o));
            if (bis.available() > 0)
            {
        ...
        certs = new org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate[tmp.size()];
        for (int i = 0; i < tmp.size(); i++)
        {
            certs[i] = (org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate)tmp.elementAt(i);
        }
     ...
     */
    public Certificate(org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate[] certs)
    {
        if (certs == null)
        {
     ...
     */
    public org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate[] getCerts()
    {
        org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate[] result = new org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate[certs.length];
