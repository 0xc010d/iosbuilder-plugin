 ...
 *
 * @deprecated use PaddedBufferedBlockCipher instead.
 */
    ...
    extends BufferedBlockCipher
{
     ...
     * @exception org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.DataLengthException if there isn't enough space in out.
     ...
     * initialised.
     * @exception org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.InvalidCipherTextException if padding is expected and not found.
     */
    public int doFinal(
        byte[]  out,
        int     outOff)
