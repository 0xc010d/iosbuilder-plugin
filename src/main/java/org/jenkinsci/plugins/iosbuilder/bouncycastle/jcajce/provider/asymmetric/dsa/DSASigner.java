package org.jenkinsci.plugins.iosbuilder.bouncycastle.jcajce.provider.asymmetric.dsa;
...
//        }
        ...
        extends DSASigner
    {
        public stdDSA()
        {
            super(new SHA1Digest(), new org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public dsa224()
        {
            super(new SHA224Digest(), new org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public dsa256()
        {
            super(new SHA256Digest(), new org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public dsa384()
        {
            super(new SHA384Digest(), new org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public dsa512()
        {
            super(new SHA512Digest(), new org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.signers.DSASigner());
        }
    }
        ...
        extends DSASigner
    {
        public noneDSA()
        {
            super(new NullDigest(), new org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.signers.DSASigner());
        }
    }
}
