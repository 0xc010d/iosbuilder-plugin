...
class CombinedHash implements Digest
{
    ...
    /**
     * @see org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.Digest#getAlgorithmName()
     */
    ...
    /**
     * @see org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.Digest#getDigestSize()
     */
    ...
    /**
     * @see org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.Digest#update(byte)
     */
    ...
    /**
     * @see org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.Digest#update(byte[],int,int)
     */
    ...
    /**
     * @see org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.Digest#doFinal(byte[],int)
     */
    ...
    /**
     * @see org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.Digest#reset()
     */
    public void reset()
    {
        md5.reset();
