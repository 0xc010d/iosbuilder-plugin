...
import org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.bc.BCObjectIdentifiers;
...
import org.jenkinsci.plugins.iosbuilder.bouncycastle.jcajce.provider.util.AsymmetricKeyInfoConverter;
 ...
 * <pre>
 * <code>
 *    security.provider.&lt;n&gt;=BouncyCastleProvider
 * </code>
 * </pre>
    ...
    implements ConfigurableProvider
{
    ...
    private void setup()
    {
        ...
        // X509Store
        //
        put("X509Store.CERTIFICATE/COLLECTION", "X509StoreCertCollection");
        put("X509Store.ATTRIBUTECERTIFICATE/COLLECTION", "X509StoreAttrCertCollection");
        put("X509Store.CRL/COLLECTION", "X509StoreCRLCollection");
        put("X509Store.CERTIFICATEPAIR/COLLECTION", "X509StoreCertPairCollection");

        put("X509Store.CERTIFICATE/LDAP", "X509StoreLDAPCerts");
        put("X509Store.CRL/LDAP", "X509StoreLDAPCRLs");
        put("X509Store.ATTRIBUTECERTIFICATE/LDAP", "X509StoreLDAPAttrCerts");
        put("X509Store.CERTIFICATEPAIR/LDAP", "X509StoreLDAPCertPairs");
        
        //
        // X509StreamParser
        //
        put("X509StreamParser.CERTIFICATE", "X509CertParser");
        put("X509StreamParser.ATTRIBUTECERTIFICATE", "X509AttrCertParser");
        put("X509StreamParser.CRL", "X509CRLParser");
        put("X509StreamParser.CERTIFICATEPAIR", "X509CertPairParser");


        //
        // KeyStore
        //
        put("KeyStore.BKS", "JDKKeyStore");
        put("KeyStore.BouncyCastle", "JDKKeyStore$BouncyCastleStore");
        put("KeyStore.PKCS12", "JDKPKCS12KeyStore$BCPKCS12KeyStore");
        put("KeyStore.BCPKCS12", "JDKPKCS12KeyStore$BCPKCS12KeyStore");
        put("KeyStore.PKCS12-DEF", "JDKPKCS12KeyStore$DefPKCS12KeyStore");

        put("KeyStore.PKCS12-3DES-40RC2", "JDKPKCS12KeyStore$BCPKCS12KeyStore");
        put("KeyStore.PKCS12-3DES-3DES", "JDKPKCS12KeyStore$BCPKCS12KeyStore3DES");

        put("KeyStore.PKCS12-DEF-3DES-40RC2", "JDKPKCS12KeyStore$DefPKCS12KeyStore");
        put("KeyStore.PKCS12-DEF-3DES-3DES", "JDKPKCS12KeyStore$DefPKCS12KeyStore3DES");
        ...
        //
        put("AlgorithmParameters.IES", "JDKAlgorithmParameters$IES");
        put("AlgorithmParameters.PKCS12PBE", "JDKAlgorithmParameters$PKCS12PBE");

        put("AlgorithmParameters." + PKCSObjectIdentifiers.id_PBKDF2, "JDKAlgorithmParameters$PBKDF2");
        ...
        put("Cipher.IES", "JCEIESCipher$IES");
        put("Cipher.BrokenIES", "JCEIESCipher$BrokenIES");

        put("Cipher.PBEWITHMD5ANDDES", "JCEBlockCipher$PBEWithMD5AndDES");
        put("Cipher.BROKENPBEWITHMD5ANDDES", "BrokenJCEBlockCipher$BrokePBEWithMD5AndDES");
        put("Cipher.PBEWITHMD5ANDRC2", "JCEBlockCipher$PBEWithMD5AndRC2");
        put("Cipher.PBEWITHSHA1ANDDES", "JCEBlockCipher$PBEWithSHA1AndDES");
        put("Cipher.BROKENPBEWITHSHA1ANDDES", "BrokenJCEBlockCipher$BrokePBEWithSHA1AndDES");
        put("Cipher.PBEWITHSHA1ANDRC2", "JCEBlockCipher$PBEWithSHA1AndRC2");

        put("Cipher.PBEWITHSHAAND128BITRC2-CBC", "JCEBlockCipher$PBEWithSHAAnd128BitRC2");
        put("Cipher.PBEWITHSHAAND40BITRC2-CBC", "JCEBlockCipher$PBEWithSHAAnd40BitRC2");
        put("Cipher.PBEWITHSHAAND128BITRC4", "JCEStreamCipher$PBEWithSHAAnd128BitRC4");
        put("Cipher.PBEWITHSHAAND40BITRC4", "JCEStreamCipher$PBEWithSHAAnd40BitRC4");
        ...
        put("Cipher.PBEWITHSHAAND128BITAES-CBC-BC", "JCEBlockCipher$PBEWithAESCBC");
        put("Cipher.PBEWITHSHAAND192BITAES-CBC-BC", "JCEBlockCipher$PBEWithAESCBC");
        put("Cipher.PBEWITHSHAAND256BITAES-CBC-BC", "JCEBlockCipher$PBEWithAESCBC");
        put("Cipher.PBEWITHSHA256AND128BITAES-CBC-BC", "JCEBlockCipher$PBEWithAESCBC");
        put("Cipher.PBEWITHSHA256AND192BITAES-CBC-BC", "JCEBlockCipher$PBEWithAESCBC");
        put("Cipher.PBEWITHSHA256AND256BITAES-CBC-BC", "JCEBlockCipher$PBEWithAESCBC");
        ...
        put("Cipher.PBEWITHMD5AND128BITAES-CBC-OPENSSL", "JCEBlockCipher$PBEWithAESCBC");
        put("Cipher.PBEWITHMD5AND192BITAES-CBC-OPENSSL", "JCEBlockCipher$PBEWithAESCBC");
        put("Cipher.PBEWITHMD5AND256BITAES-CBC-OPENSSL", "JCEBlockCipher$PBEWithAESCBC");
        
        put("Cipher.PBEWITHSHAANDTWOFISH-CBC", "JCEBlockCipher$PBEWithSHAAndTwofish");
        put("Cipher.OLDPBEWITHSHAANDTWOFISH-CBC", "BrokenJCEBlockCipher$OldPBEWithSHAAndTwofish");
        ...
        //
        put("SecretKeyFactory.PBEWITHMD2ANDDES", "JCESecretKeyFactory$PBEWithMD2AndDES");
        ...
        put("SecretKeyFactory.PBEWITHMD2ANDRC2", "JCESecretKeyFactory$PBEWithMD2AndRC2");
        put("SecretKeyFactory.PBEWITHMD5ANDDES", "JCESecretKeyFactory$PBEWithMD5AndDES");
        put("SecretKeyFactory.PBEWITHMD5ANDRC2", "JCESecretKeyFactory$PBEWithMD5AndRC2");
        put("SecretKeyFactory.PBEWITHSHA1ANDDES", "JCESecretKeyFactory$PBEWithSHA1AndDES");
        put("SecretKeyFactory.PBEWITHSHA1ANDRC2", "JCESecretKeyFactory$PBEWithSHA1AndRC2");
        put("SecretKeyFactory.PBEWITHSHAAND3-KEYTRIPLEDES-CBC", "JCESecretKeyFactory$PBEWithSHAAndDES3Key");
        put("SecretKeyFactory.PBEWITHSHAAND2-KEYTRIPLEDES-CBC", "JCESecretKeyFactory$PBEWithSHAAndDES2Key");
        put("SecretKeyFactory.PBEWITHSHAAND128BITRC4", "JCESecretKeyFactory$PBEWithSHAAnd128BitRC4");
        put("SecretKeyFactory.PBEWITHSHAAND40BITRC4", "JCESecretKeyFactory$PBEWithSHAAnd40BitRC4");
        put("SecretKeyFactory.PBEWITHSHAAND128BITRC2-CBC", "JCESecretKeyFactory$PBEWithSHAAnd128BitRC2");
        put("SecretKeyFactory.PBEWITHSHAAND40BITRC2-CBC", "JCESecretKeyFactory$PBEWithSHAAnd40BitRC2");
        put("SecretKeyFactory.PBEWITHSHAANDTWOFISH-CBC", "JCESecretKeyFactory$PBEWithSHAAndTwofish");
        put("SecretKeyFactory.PBEWITHHMACRIPEMD160", "JCESecretKeyFactory$PBEWithRIPEMD160");
        put("SecretKeyFactory.PBEWITHHMACSHA1", "JCESecretKeyFactory$PBEWithSHA");
        put("SecretKeyFactory.PBEWITHHMACTIGER", "JCESecretKeyFactory$PBEWithTiger");
        
        put("SecretKeyFactory.PBEWITHMD5AND128BITAES-CBC-OPENSSL", "JCESecretKeyFactory$PBEWithMD5And128BitAESCBCOpenSSL");
        put("SecretKeyFactory.PBEWITHMD5AND192BITAES-CBC-OPENSSL", "JCESecretKeyFactory$PBEWithMD5And192BitAESCBCOpenSSL");
        put("SecretKeyFactory.PBEWITHMD5AND256BITAES-CBC-OPENSSL", "JCESecretKeyFactory$PBEWithMD5And256BitAESCBCOpenSSL");

        put("SecretKeyFactory." + CryptoProObjectIdentifiers.gostR3411, "JCESecretKeyFactory$PBEWithGOST3411");
        ...
        put("SecretKeyFactory.PBEWITHSHAAND128BITAES-CBC-BC", "JCESecretKeyFactory$PBEWithSHAAnd128BitAESBC");
        put("SecretKeyFactory.PBEWITHSHAAND192BITAES-CBC-BC", "JCESecretKeyFactory$PBEWithSHAAnd192BitAESBC");
        put("SecretKeyFactory.PBEWITHSHAAND256BITAES-CBC-BC", "JCESecretKeyFactory$PBEWithSHAAnd256BitAESBC");
        put("SecretKeyFactory.PBEWITHSHA256AND128BITAES-CBC-BC", "JCESecretKeyFactory$PBEWithSHA256And128BitAESBC");
        put("SecretKeyFactory.PBEWITHSHA256AND192BITAES-CBC-BC", "JCESecretKeyFactory$PBEWithSHA256And192BitAESBC");
        put("SecretKeyFactory.PBEWITHSHA256AND256BITAES-CBC-BC", "JCESecretKeyFactory$PBEWithSHA256And256BitAESBC");
    ...
    // Certification Path API
        put("CertPathValidator.RFC3281", "PKIXAttrCertPathValidatorSpi");
        put("CertPathBuilder.RFC3281", "PKIXAttrCertPathBuilderSpi");
        put("CertPathValidator.RFC3280", "PKIXCertPathValidatorSpi");
        put("CertPathBuilder.RFC3280", "PKIXCertPathBuilderSpi");
        put("CertPathValidator.PKIX", "PKIXCertPathValidatorSpi");
        put("CertPathBuilder.PKIX", "PKIXCertPathBuilderSpi");
        put("CertStore.Collection", "CertStoreCollectionSpi");
        put("CertStore.LDAP", "X509LDAPCertStoreSpi");
        put("CertStore.Multi", "MultiCertStoreSpi");
    ...
    private void addMacAlgorithms()
    {
        ...
        put("Mac.DESWITHISO9797", "JCEMac$DES9797Alg3");
        put("Alg.Alias.Mac.DESISO9797MAC", "DESWITHISO9797");

        put("Mac.ISO9797ALG3MAC", "JCEMac$DES9797Alg3");
        put("Alg.Alias.Mac.ISO9797ALG3", "ISO9797ALG3MAC");
        put("Mac.ISO9797ALG3WITHISO7816-4PADDING", "JCEMac$DES9797Alg3with7816d4");
        put("Alg.Alias.Mac.ISO9797ALG3MACWITHISO7816-4PADDING", "ISO9797ALG3WITHISO7816-4PADDING");

        put("Mac.OLDHMACSHA384", "JCEMac$OldSHA384");

        put("Mac.OLDHMACSHA512", "JCEMac$OldSHA512");

        put("Mac.PBEWITHHMACSHA", "JCEMac$PBEWithSHA");
        put("Mac.PBEWITHHMACSHA1", "JCEMac$PBEWithSHA");
        put("Mac.PBEWITHHMACRIPEMD160", "JCEMac$PBEWithRIPEMD160");
