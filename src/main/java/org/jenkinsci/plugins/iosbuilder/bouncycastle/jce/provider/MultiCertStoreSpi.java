...
import org.jenkinsci.plugins.iosbuilder.bouncycastle.jce.MultiCertStoreParameters;
    ...
    extends CertStoreSpi
{
        ...
        throws InvalidAlgorithmParameterException
    {
        ...
        {
            throw new InvalidAlgorithmParameterException("MultiCertStoreSpi: parameter must be a MultiCertStoreParameters object\n" +  params.toString());
        }
