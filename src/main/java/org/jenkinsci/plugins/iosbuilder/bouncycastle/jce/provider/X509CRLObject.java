...
import org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.CRLNumber;
...
import org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.TBSCertList;
            ...
            for (int i = 0; i < certs.length; i++)
            {
                ...
                if (certs[i].getUserCertificate().getValue().equals(serial))
                {
                    ...
                    else
                    {
                        try
                        {
                            issuer = org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate.getInstance(cert.getEncoded()).getIssuer();
                        }
