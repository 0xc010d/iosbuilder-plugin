...
import org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.*;
...
public class TlsUtils
{
    ...
    static void validateKeyUsage(org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate c, int keyUsageBits) throws IOException
    {
