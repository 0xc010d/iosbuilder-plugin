...
public class EC5Util
{
    ...
    public static org.jenkinsci.plugins.iosbuilder.bouncycastle.jce.spec.ECParameterSpec convertSpec(
        ECParameterSpec ecSpec,
        boolean withCompression)
    {
        ECCurve curve = convertCurve(ecSpec.getCurve());

        return new org.jenkinsci.plugins.iosbuilder.bouncycastle.jce.spec.ECParameterSpec(
            curve,
    ...
    public static org.jenkinsci.plugins.iosbuilder.bouncycastle.math.ec.ECPoint convertPoint(
        ECParameterSpec ecSpec,
        ECPoint point,
        boolean withCompression)
    {
