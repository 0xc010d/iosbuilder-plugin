package org.jenkinsci.plugins.iosbuilder.bouncycastle.x509.util;
...
import org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.CertificatePair;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.jce.X509LDAPCertStoreParameters;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.jce.provider.X509AttrCertParser;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.jce.provider.X509CRLParser;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.jce.provider.X509CertPairParser;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.jce.provider.X509CertParser;
...
import org.jenkinsci.plugins.iosbuilder.bouncycastle.x509.X509CertPairStoreSelector;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.x509.X509CertStoreSelector;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.x509.X509CertificatePair;
 ...
 * {@link org.jenkinsci.plugins.iosbuilder.bouncycastle.jce.X509LDAPCertStoreParameters} with the given
 * information of the subject (for all kind of certificates) or issuer (for
 * CRLs), respectively, if a {@link org.jenkinsci.plugins.iosbuilder.bouncycastle.x509.X509CertStoreSelector} or
 * {@link org.jenkinsci.plugins.iosbuilder.bouncycastle.x509.X509AttributeCertificate} is given with that
 * details.
 * <p/>
...
public class LDAPStoreHelper
{
     ...
     * {@link org.jenkinsci.plugins.iosbuilder.bouncycastle.x509.X509CertStoreSelector} of the given
     * selector.
     *
     * @param xselector             The selector with the search criteria.
