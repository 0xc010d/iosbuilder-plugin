...
import org.jenkinsci.plugins.iosbuilder.bouncycastle.pqc.asn1.RainbowPrivateKey;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.pqc.crypto.rainbow.Layer;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.pqc.crypto.rainbow.RainbowPrivateKeyParameters;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.pqc.crypto.rainbow.util.RainbowUtil;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.pqc.jcajce.spec.RainbowPrivateKeySpec;
    ...
    implements PrivateKey
{
    ...
    public int hashCode()
    {
        ...
        hash = hash * 37 + org.jenkinsci.plugins.iosbuilder.bouncycastle.util.Arrays.hashCode(A1inv);
        hash = hash * 37 + org.jenkinsci.plugins.iosbuilder.bouncycastle.util.Arrays.hashCode(b1);
        hash = hash * 37 + org.jenkinsci.plugins.iosbuilder.bouncycastle.util.Arrays.hashCode(A2inv);
        hash = hash * 37 + org.jenkinsci.plugins.iosbuilder.bouncycastle.util.Arrays.hashCode(b2);
        hash = hash * 37 + org.jenkinsci.plugins.iosbuilder.bouncycastle.util.Arrays.hashCode(vi);
