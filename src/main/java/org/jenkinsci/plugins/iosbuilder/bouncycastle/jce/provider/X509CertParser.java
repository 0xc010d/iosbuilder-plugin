...
import org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.pkcs.SignedData;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.x509.X509StreamParserSpi;
import org.jenkinsci.plugins.iosbuilder.bouncycastle.x509.util.StreamParsingException;
    ...
    extends X509StreamParserSpi
{
        ...
        throws IOException, CertificateParsingException
    {
        ...
        return new X509CertificateObject(
                            org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate.getInstance(seq));
    }
        ...
        throws CertificateParsingException
    {
        if (sData != null)
        {
            while (sDataObjectCount < sData.size())
            {
                ...
                {
                   return new X509CertificateObject(
                                    org.jenkinsci.plugins.iosbuilder.bouncycastle.asn1.x509.Certificate.getInstance(obj));
                }
            }
        }
