 ...
 * @see org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.params.AEADParameters
 */
public interface AEADBlockCipher
{
     ...
     * @throws org.jenkinsci.plugins.iosbuilder.bouncycastle.crypto.InvalidCipherTextException if the MAC fails to match.
     */
